...
/**
 * Common utility class containing reusable methods for creating pets and manipulating payloads.
 * <p>
 * This class provides methods for creating pet objects, generating random pet data,
 * and creating API requests for adding pets.
 * </p>
 */
...
public class ReusableMethods {
	 ...
	 /**
     * Creates a pet and returns its ID, while also adding it to the list for cleanup.
     * <p>
     * This method generates random data for a new pet and sends a request to create the pet.
     * The pet ID is extracted from the response and returned.
     * </p>
     *
     * @param requestSpec     the ThreadLocal holding the request specification
     * @param createdPetIds   the ThreadLocal list that holds IDs of created pets for cleanup
     ...
     * <p>
     * This method builds a Pet object using the provided values, and assigns a category and tag to the pet.
     * </p>
     *
